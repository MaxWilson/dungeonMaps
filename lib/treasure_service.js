...
var service = {
    "gurpsdf": 'https://df-treasure-generator.herokuapp.com/v1/generate/',
    "dfrpg": 'https://syndaryl.hopto.org:5050/api/selected'
};
remote_reaction();
...
function test_treasure_service_connection() {
    ...
    request.open('GET', service.gurpsdf, false);
...
function fetch_remote_container(room, element, capacity, value_min, value_max) {
    ...
    var request_url = 'https://df-treasure-generator.herokuapp.com/v1/generate/1/Containers?min=' + value.min + '&max=' + value.max ;
    var request = new XMLHttpRequest();
...
function fetch_remote_treasure(room, element, value_min, value_max, has_container) {
    ...
    var request_url = 'https://df-treasure-generator.herokuapp.com/v1/generate/1?max=' + value.max + '&min=' + value.min;
    var request = new XMLHttpRequest();
    request.open('GET', request_url, true);
